...
int main() {
    ...
    double x_Rmin = 0.1;
    double x_Rmax = 0.4;
    int num_x_Rvalues = 50; //número de valores de T para variar
    double x_Rstep = (x_Rmax - x_Rmin) / (num_x_Rvalues - 1);
    //abre o arquivo de saída
    std::ofstream outfile("ISImedioporX_R.dat");
    ...
    for (int i = 0; i < num_x_Rvalues; ++i) {
        double x_R = x_Rmin + i * x_Rstep;
        ...
        std::cout << "x_R = " << x_R << ", ISI médio = " << isi_mean << std::endl;
    }
...
//! gnuplot -persist -e "set terminal wxt size 800,600; set xlabel 'T'; set ylabel 'x_R'; set zlabel 'ISI'; set grid; splot 'C:/Users/luizf/Desktop/C e C++/projetos C++/ISI/ISI por x_R/ISImedioporX_R.dat' using 2:1:3 with points palette pointsize 1 pointtype 7"
